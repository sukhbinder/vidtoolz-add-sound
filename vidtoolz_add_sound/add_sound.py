...
def add_audio_to_video(
    video_path, audio_path, start_time, original_audio_volume=100, loop_audio=True, audio_start_time=0
):
    video = VideoFileClip(video_path)
    sound = AudioFileClip(audio_path).with_start(audio_start_time)
